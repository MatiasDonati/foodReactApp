    ...
    return (
        <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
            ...
            <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500[px]]'>
                ...
                <input className='bg-transparent p-2 w-full focus:outline-none' type="text" placeholder='Buscar comidas...' />
            </div>
            {/* Boton del Carrito */}
            <button className='bg-black text-white hidden md:flex items-center py-2 rounded-full'>
                <BsFillCartFill size={20} className='mr-2' /> Pedidos
            </button>
            ...
            <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' :
                ...
                <nav>
                    <ul className='flex flex-col p-4 text-gray-800'>
                        ...
                        <li className='text-xl py-4 flex'><FaWallet size={25} className='mr-4' />Medios de Pago</li>
                        <li className='text-xl py-4 flex'><MdHelp size={25} className='mr-4' />Soporte</li>
                        <li className='text-xl py-4 flex'><AiFillTag size={25} className='mr-4' />Promociones</li>
                        <li className='text-xl py-4 flex'><BsFillSaveFill size={25} className='mr-4' />Recomendados</li>
                        <li className='text-xl py-4 flex'><FaUserFriends size={25} className='mr-4' />Invita un amigo</li>
                    </ul>
                </nav>
            </div>
        </div>
