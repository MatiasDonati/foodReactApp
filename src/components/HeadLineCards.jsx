        ...
        <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
            ...
            <div className='rounded-xl relative'>
                ...
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                    <p className='font-bold text-2xl px-2 pt-4'>Comete Algo Rico</p>
                    <p className='px-2'>Desde $800</p>
                    <button className='border-white bg-white text-black mx-2 absolute bottom-4'>Pedí Ya!</button>
                </div>
                <img
            ...
            <div className='rounded-xl relative'>
                ...
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                    ...
                    <p className='px-2'>Agregado diariamente</p>
                    <button className='border-white bg-white text-black mx-2 absolute bottom-4'>Pedí Ya!</button>
                </div>
                <img
                className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl'
            ...
            <div className='rounded-xl relative'>
                {/* Overlay */}
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                    <p className='font-bold text-2xl px-2 pt-4'>Probá nuestos Postres</p>
                    <p className='px-2'>Cositas Ricas</p>
                    <button className='border-white bg-white text-black mx-2 absolute bottom-4'>Pedí Ya!</button>
                </div>
                <img
                className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl'
